...
type AttributeValueDoubleQuotes struct{}

// ReviewerName returns the reviewer name.
func (a AttributeValueDoubleQuotes) Accepts(path string) bool {
	return true
}

// Accepts checks if the file can be reviewed.
func (a AttributeValueDoubleQuotes) ReviewerName() string {
...
func (a AttributeValueDoubleQuotes) Review(path string, page io.Reader) ([]Fault, error) {
	var fault []Fault
